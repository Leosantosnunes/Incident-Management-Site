...
export class StaticDataSource{
    private movies: Movie[] = [
        ...
        new Movie(3, 'Toy Sadtory','John Lasdasseter','November 22, 1995', 8.3,'01_ts.jpg' ),
        new Movie(4, 'Toy Story','Johasdn Lasseter','November 22, 1995', 8.3,'01_ts.jpg' ),
        new Movie(5, 'Toy Story','John Lasssdaeter','November 22, 1995', 8.3,'01_ts.jpg' ),
        ...
        new Movie(8, 'Toy Story','John Lasdscsseter','November 22, 1995', 8.3,'01_ts.jpg' ),
